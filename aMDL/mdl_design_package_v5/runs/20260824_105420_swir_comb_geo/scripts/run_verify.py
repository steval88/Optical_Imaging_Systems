...
# I(r0, z) per wavelength on a grid around the design focus, computed
# with the same J0-reduced RS-I kernel as the metrics above. Defaults
# match the paper's tile window (r = +/-20 um, z = F +/- 1 mm).
...
log("r-z maps (%d z-planes x %d radii per wavelength)..."
    % (rz_z.size, rz_r.size))
for lam in lam_list:
