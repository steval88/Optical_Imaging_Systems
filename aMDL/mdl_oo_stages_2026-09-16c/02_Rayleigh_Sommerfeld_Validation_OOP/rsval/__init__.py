...
``02_Rayleigh_Sommerfeld_Validation_OOP`` and produces byte-for-byte the same
...
----------
    ...
    mtf.py         MtfRun        -- window-normalized incoherent MTF from
                                    ...
                                    rs/fig_mtf.png
    plots.py       PlotRun       -- the figures of a verified run folder:
                                    fig_onaxis, fig_psf, fig_psf_2d,
                                    fig_rz_tiles, fig_metrics (make_plots.py)
...
__all__ = ["Log", "Stage", "parse_cli", "resolve_run_dir", "DesignState", "VerifyConfig",
           "import_mdl_problem", "MtfRun", "hankel_mtf", "PlotRun", "RSPropagator",
