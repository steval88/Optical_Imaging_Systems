...
read (02_validation_rs_oo/run_verify.py, mtf_verify.py,
02_validation_zemax_oo, 01_design_oo/fom_quadrature_check.py), so a run
...
STAGE_SNAPSHOT: Tuple[str, ...] = (
    ...
    "01_design_oo/mdl",
    "02_validation_rs_oo/run_verify.py",
    "02_validation_rs_oo/mtf_verify.py",
    "02_validation_rs_oo/rsval",
    "02_validation_zemax_oo/mdl_zemax_validation.py",
    "02_validation_zemax_oo/zval",
    "03_tapeout_oo/export_gds.py",
    "03_tapeout_oo/gdsout",
)
NEXT_STAGE_CMD = os.path.join("02_validation_rs_oo", "run_verify.py")
...
class DesignConfig:
    ...
    # -- verification (consumed by 02_validation_rs_oo) -------------------
