...
Usage in your scripts:
    ...
    ...
    zos.close()                    # closes the OpticStudio instance cleanly
...
class PythonStandaloneApplication:
    ...
    def close(self):
        """Close the headless OpticStudio instance.

        Call this explicitly (or register it with atexit) when your script
        is done.  It is idempotent, so calling it more than once is safe.
        """
